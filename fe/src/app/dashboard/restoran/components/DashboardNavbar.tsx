...
const NAV_LINKS = [
  { href: "/dashboard/restoran", label: "Beranda", exact: true },
  { href: "/dashboard/restoran/ai-search", label: "AI Search", exact: false },
  { href: "/dashboard/restoran/peta", label: "Peta & Cari Petani", exact: false },
  { href: "/dashboard/restoran/pesanan", label: "Pesanan Saya", exact: false },
  { href: "/dashboard/restoran/riwayat", label: "Riwayat & Tagihan", exact: false },
];
    ...
    <>
      ...
      >
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          {/* Logo */}
          <Link
            href="/dashboard/restoran"
            aria-label="TaniConnect — Dashboard"
            className="shrink-0"
          >
            <Image
              src="/logo.png"
        ...
        >
          ...
          <div className="mt-auto px-6 py-6 border-t border-gray-100 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Pemilik Restoran</p>
            </div>
          </div>
        </div>
      )}
